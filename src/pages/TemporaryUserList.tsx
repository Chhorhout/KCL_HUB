...
const API_BASE_URL = 'http://localhost:5092/api/TemporaryUser'
      ...
      <main className="flex-1 ml-72 px-6 py-8">
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl font-bold text-blue-600">Temporary User</h1>
            </div>
            <button
            ...
            <form onSubmit={handleSubmit} className="p-6">
              <div className="mb-4">
                ...
                <input
                  ...
                  placeholder="e.g., Contractor account"
                  required
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 border-2 border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                  placeholder="e.g., Short-term project contractor"
                  rows={4}
                />
              </div>
